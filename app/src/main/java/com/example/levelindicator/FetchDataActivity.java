...
public class FetchDataActivity extends AppCompatActivity {
    ...
    String url = "http://192.168.43.107/smart_bin/metalic_sensor.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue queue = Volley.newRequestQueue(FetchDataActivity.this);
...
// we will call if we get any error from API.
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, response -> {
            ...
            try {
                ...
                String courseName = response.getString("bin1");
            ...
            Toast.makeText(FetchDataActivity.this, "Failed to get data..", Toast.LENGTH_SHORT).show();
        });
