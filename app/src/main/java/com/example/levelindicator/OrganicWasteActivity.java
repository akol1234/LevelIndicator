...
public class OrganicWasteActivity extends AppCompatActivity {
    ...
    String url = "http://192.168.43.107/smart_bin/organic_sensor.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_organic_waste);
        ...
        RequestQueue queue = Volley.newRequestQueue(OrganicWasteActivity.this);
...
// we will call if we get any error from API.
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, response -> {
            ...
            try {
                ...
                String courseName = response.getString("bin2");
            ...
            Toast.makeText(OrganicWasteActivity.this, "Failed to get data..", Toast.LENGTH_SHORT).show();
        });
