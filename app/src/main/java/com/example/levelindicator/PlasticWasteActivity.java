...
public class PlasticWasteActivity extends AppCompatActivity {
    ...
    String url = "http://192.168.43.107/smart_bin/plastic_sensor.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_plastic_waste);
        ...
        RequestQueue queue = Volley.newRequestQueue(PlasticWasteActivity.this);
...
// we will call if we get any error from API.
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, response -> {
            ...
            try {
                ...
                String courseName = response.getString("bin4");
            ...
            Toast.makeText(PlasticWasteActivity.this, "Failed to get data..", Toast.LENGTH_SHORT).show();
        });
